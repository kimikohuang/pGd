...
print(ndaGoldHis_4_columns.shape)
print(ndaGoldHis_4_columns[0:10])
exit
ndaGoldHis2 = numpy.concatenate((ndaGoldHis_4_columns[1:],numpy.array([[0,0,0,0]])), axis=0)
print(ndaGoldHis2[0:10])
#ndaGoldHis2m1 = ndaGoldHis2 - ndaGoldHis_4_columns
ndaG3 = ndaGoldHis_4_columns[1:]-ndaGoldHis_4_columns[0:-1]
print(ndaG3.shape)
print(ndaG3[0:10])
